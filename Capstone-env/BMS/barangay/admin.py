...
from .views.models import Accounts, Residents, Bhw, Account_Type, Personnel, HealthService, Schedule, Services, Outbreaks, Request, Bsi,HealthAdmin, Maintenance,Medicine, CommunityNotice,Immunize, ImmunizeDate
...
admin.site.register(ImmunizeDate)
